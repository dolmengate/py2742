...
class Game:
    ...
    def _add_player(self) -> int:
        ...
        self.world.add_component(player, Renderable(image=pygame.image.load("redsquare.png"), posx=100, posy=100))
        return player

    def _add_enemy(self, x=400, y=250):
        enemy = self.world.create_entity()
        self.world.add_component(enemy, Renderable(image=pygame.image.load("bluesquare.png"), posx=x, posy=y))
